...
def tree(work_dir, depth=0):
    '''
    show the dirctory in a tree struct
    '''
    for filename in os.listdir(work_dir):
        ...
        print(' '*depth, end='')
        if filename == os.listdir(work_dir)[-1]:
            print('└─', end='')
        else:
            print('├─', end='')
...
#     # sys.exit(main())
#     main()
# tree(r'C:\Users\okieM\Desktop\cstring-3.6.2\cstring-3.6.2\include')
